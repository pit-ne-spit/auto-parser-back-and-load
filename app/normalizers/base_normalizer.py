"""Base normalizer class with common functionality."""
...
class BaseNormalizer:
    ...
    def __init__(self, operation_type: str = "normalization"):
        """
        Initialize base normalizer.
        
        Args:
            operation_type: Type of operation (default: "normalization")
        """
